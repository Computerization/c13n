---
title: "游戏引擎中的实体组件系统（ECS）架构设计"
author: "黄京"
date: "Jul 28, 2026"
description: "ECS 架构：组合优于继承，数据导向驱动高性能游戏引擎设计"
latex: true
pdf: true
---
...
实体 ID 的管理需要兼顾复用与安全。引入版本号（Generation）可有效防止悬垂引用，而稀疏-紧凑数组（Sparse Set）则能在 O(1) 时间内完成查找与迭代。组件的存储通常按 Archetype 分组，位掩码（Signature）用于快速匹配查询条件，避免每帧重建过滤器。
