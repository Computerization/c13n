---
title: "RISC-V 内核移植与调试实践"
author: "王思成"
date: "Jun 27, 2026"
description: "RISC-V 裸机到 MMU Linux 移植全流程"
latex: true
pdf: true
---
...
常用基准包括 UnixBench、CoreMark、lmbench 与 iperf3。测试时需固定主频并关闭动态调频，以获得可重复结果。与 ARM Cortex-A53 同主频对比可直观反映 RISC-V 在整数与浮点运算上的差异。
