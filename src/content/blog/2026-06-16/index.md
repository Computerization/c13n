...
author: "杨子凡"
date: "Jun 16, 2026"
description: "分布式一致性模型：从 CAP 到 CRDT 的权衡与实践"
latex: true
pdf: true
---
...
当网络分区发生时，强求强一致性只会让系统整体不可用，这是 CAP 证明的直接结论。监控体系应关注「可见延迟」而非仅关注 99th 响应时间：前者直接反映用户感知的陈旧数据风险。灰度发布时，建议先用金丝雀集群验证一致性边界，再全量切换。文档先行同样重要：把一致性级别写入 SLA 与运行手册，避免运维人员在故障现场临时决策。
