...
author: "杨其臻"
date: "May 24, 2026"
description: "指针到页表：现代内存管理的演进与实践"
latex: true
pdf: true
---
...
Linux 内核的物理内存分配以伙伴系统为核心。伙伴系统把空闲内存按 2 ⁿ 组织成多个链表，当请求大小介于 2 ᵏ⁻ ¹ 与 2 ᵏ 之间时，从 2 ᵏ 链表中拆分一块使用；释放时若相邻块也是空闲且大小相同，则合并为更大块，从而减少外部碎片。SLAB/SLUB/SLOB 分配器在伙伴系统之上构建对象缓存，按对象类型着色以避免缓存行冲突，显著降低小对象分配的开销。
