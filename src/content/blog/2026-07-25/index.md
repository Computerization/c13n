---
title: "空间编程语言：二维代码书写方式"
author: "叶家炜"
date: "Jul 25, 2026"
description: "二维画布上可视化编程的范式探索"
latex: true
pdf: true
---
...
空间编程语言首先需要一套坐标系统。最常用的是笛卡尔平面，原点位于画布左上角，X 轴向右，Y 轴向下。每个语法元素被赋予一个矩形包围盒，左上角坐标为 $\left(x,y\right)$，宽高分别为 $w$ 和 $h$。区域之间存在三种基本拓扑关系：相邻、包含、相交。相邻关系用于表达顺序执行或数据流动，包含关系用于表达作用域或模块嵌套，相交关系则用于表达共享状态或冲突检测。
