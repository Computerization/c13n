---
title: "C/C++ 构建工具的设计与实现"
author: "王思成"
date: "Apr 09, 2026"
description: "剖析 C/C++ 构建工具设计原理与核心实现技术"
latex: true
pdf: true
---
...
Ninja 于 2011 年推出，专注于构建执行速度而非描述语言。它使用简洁的 .ninja 文件格式，规则定义如 rule cc $out = $in $in_newline = $newline command = gcc -c $in -o $out。这种格式易解析，支持极致并行，通过依赖文件 .ninja_deps 记录头文件扫描结果。Ninja 不处理跨平台，通常与 CMake 或 GN 搭配使用，其速度优势源于最小化解析开销和工作窃取调度。
