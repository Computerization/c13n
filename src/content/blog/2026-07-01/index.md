...
author: "李睿远"
date: "Jul 01, 2026"
description: "流式处理架构设计与性能调优全流程指南"
latex: true
pdf: true
---
...
Auto-Scaling 机制如 Kubernetes Pod Autoscaler 与 Flink Reactive Mode 可根据背压或延迟指标动态调整并行度。Serverless Flink（如阿里云、AWS Kinesis Analytics、Ververica Platform）进一步将资源抽象为计算单元 CU，按实际使用量计费。成本模型对比显示，常驻集群适合稳定高负载，而 Serverless 更适合波动明显的业务。
